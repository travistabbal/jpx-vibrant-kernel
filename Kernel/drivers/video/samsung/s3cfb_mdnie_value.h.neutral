#define CBVAL	0x8000	//cb C 0x8300=+3, N 0x8000=0, W 0x7900=-7
#define CRVAL	0x0080	//cr C 0x007D=-3, N 0x0080=0, W 0x0087=+7
...
mDNIe_data_type mDNIe_Video[]= 
{
	...
	0x009c,0x07f0, //de 127, ce off //de 63
	0x00ac,0x0100, //skin detect off, cs 512 //cs 256
	0x00b4,0x0001, //de th.
...
mDNIe_data_type mDNIe_UI[]= 
{
	...
	0x0094,0x0fff, //directional th.
	0x0098,0x005c, //simplicity th.
	0x009c,0x0010, //0x01f0 de 15, ce off //0x00f0 de 7, ce off //0x0010 de 0, ce off //de off, ce off
	0x00ac,0x0020, //skin detect off, cs 32
	0x00b4,0x0100, //de th.
	0x0120,0x0064, //MCM 10000K
	0x0140,CBVAL, //cb C 0x8700=+7, N 0x8000=0, W 0x7900=-7
	0x0148,CRVAL, //cr C 0x0079=-7, N 0x0080=0, W 0x0087=+7
	0x0134,0xFFF8, //LSF 248
	END_SEQ, 0x0000,
#if 0
	//no mcm version
